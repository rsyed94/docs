...
1. In **Agents**, create a managed agent with a name, purpose, and active human owner. Open its detail page and select the company account, repository, and actions it needs. Set the grant expiry and whether each action requires approval. New agents have no access until configured.
