...
Passport Desktop includes company access requests in **Apps**, managed action reviews in **Approvals**, and your run and receipt history in **Activity**. Agent administration and company account setup remain on the web, available through **Settings → Open Passport on the web**.
