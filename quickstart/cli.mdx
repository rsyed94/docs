...
Passport CLI is the official cross-platform path for Windows, Linux, and macOS. It requires Node.js 20 or newer; Windows and Linux do not require or ship a Passport desktop application.
