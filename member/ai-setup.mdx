---
title: "Your AI setup"
description: "Get the agents, connections, and practical workflows your team has prepared for you."
---

Open **Setup** in your Passport workspace to see your assigned agents and tools. Each item shows what is ready and what needs attention. Your admin publishes the setup for your team; your existing access rules still apply.

## Get ready

1. Open **Agents** to connect an approved agent. Install the vendor's app and sign in with your existing account when prompted.
...
Passport reports what it can verify. A connected agent does not prove that every workflow is installed on every computer. Desktop checks the local installation separately.

## Install a workflow on your Mac

In Passport Desktop, open **Workflows**, choose a published workflow and supported agent, then review the instructions and local changes before installing. Managed workflow skills support **Claude Code** and **Codex**. Restart or reopen the agent if it has not picked up a newly installed skill.
...
Your agent still needs its normal Passport connection and vendor account. Installing instructions does not bypass approvals or grant new permissions.
