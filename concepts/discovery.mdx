...
The default mode is `auto`. Free and Pro stay on that default. Enterprise workspace Settings can show a pinned non-auto mode if one was previously set, with a control to switch back to `auto`.
